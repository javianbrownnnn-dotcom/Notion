...
3. **Production prompts live in the [Prompt Library](../databases/prompts.md) only.** Personal ad-hoc prompts for shipped work are banned — untracked prompts mean untraceable quality drift.
